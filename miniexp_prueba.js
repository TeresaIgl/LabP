...
let expName = 'miniexp_prueba';  // from the Builder filename that created this script
let expInfo = {
...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'words.xlsx', 'path': 'words.xlsx'},
  ]
});
...
async function experimentInit() {
  ...
  text = new visual.TextStim({
    win: psychoJS.window,
    name: 'text',
    text: 'you will see words in the screen if it is real click the LEFT arrow, if not the RIGHT arrow\n\n\nClick SPACEBAR to begin',
    font: 'Arial',
    units: undefined, 
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials = new TrialHandler({
      ...
      trialList: 'C:/Teresa 1TSI/Lab Project II/Online psychopy/prueba/words.xlsx',
...
function testRoutineBegin(snapshot) {
  return async function () {
    ...
    testComponents.push(key_resp_2);
